    ...
    implements Mage_Widget_Block_Interface
{
    ...
    protected $_titleValue = array(
        ...
        "missouri"              => "Local Areas in",
        "montana"               => "Servicing Areas in",
        "nebraska"              => "Regional Cities in",
        "nevada"                => "Local Service Zones in",
        "new-hampshire"         => "Service Destinations in",
        "new-jersey"            => "Cities in",
        ...
        "pennsylvania"          => "Local Areas of",
        "rhode-island"          => "Destination Districts of",
        "south-carolina"        => "Regions Serviced in",
        "south-dakota"          => "Areas in",
        "tennessee"             => "Surrounding Cities in",
        "texas"                 => "Destination Zones in",
        "utah"                  => "Local Areas in",
        "vermont"               => "Areas Served in",
        "virginia"              => "Cities Served in",
        "washington"            => "Local Cities Served in",
        "west-virginia"         => "Local Districts of",
        "wisconsin"             => "Servicing Local Cities in",
        "wyoming"               => "Destination Zones in"
    );
