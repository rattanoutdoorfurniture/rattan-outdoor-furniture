...
class BusinessDecision_Interaktingslider_Block_Admin_Slide_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
    	...
    	$fieldset->addField('image', 'image', array(
            'name'      => 'image',
            'label'     => Mage::helper('interaktingslider')->__('Image'),
            'title'     => Mage::helper('interaktingslider')->__('Image'),
            'required'  => true,
           
        ));
		
		$fieldset->addField('xpos', 'text', array(
            'name'      => 'xpos',
            'label'     => Mage::helper('interaktingslider')->__('X position'),
            'title'     => Mage::helper('interaktingslider')->__('X position'),
            'required'  => true,
			'width' => '100px'
           
        ));
		
		$fieldset->addField('ypos', 'text', array(
            'name'      => 'ypos',
            'label'     => Mage::helper('interaktingslider')->__('Y position'),
            'title'     => Mage::helper('interaktingslider')->__('Y position'),
            'required'  => true,
		...
		$fieldset->addField('type', 'select', array(
            'name'      => 'type',
            'label'     => Mage::helper('interaktingslider')->__('Type'),
            'title'     => Mage::helper('interaktingslider')->__('Type'),
            'required'  => true,
			'values' => array('expandDown'=>"expandDown",'expandTop'=>"expandTop",'expandLeft'=>"expandLeft",'expandRight'=>"expandRight")
